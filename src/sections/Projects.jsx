        ...
        <main className="flex-1 px-4 py-12 sm:px-6 lg:px-8"> {/* Padded content area */}
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mb-1 text-center">
              ...
              {/* Page description */}
              <p className="mx-auto mt-4 max-w-2xl text-lg text-[var(--text-secondary)]">A selection of my best work, showcasing my skills and experience in web development. For a better experience view these models on a laptop or desktop devide, since the mobile versions are still in development.</p>
            </div>
