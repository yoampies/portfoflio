          ...
          <div className="w-full max-w-4xl"> 
            ...
            <div className="flex flex-col items-center gap-8 md:flex-row md:gap-12">
              ...
              <div className="text-center md:text-left"> 
                ...
                <p className="mt-4 text-lg text-[#4d4d4d]">Web Developer blending art and code to create immersive web experiences. I specialize in building high-performance applications with React, bringing them to life with captivating animations using GSAP and engaging 3D visuals with React Three Fiber.</p> 
            ...
            <div className="mt-20"> 
              ...
              <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-6"> 
                {Object.entries(skillIcons).map(([title, icon]) => (
                  <SkillCard 
                    key={title} 
                    title={title} 
                    icon={icon} 
